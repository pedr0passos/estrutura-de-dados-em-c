...
Lista *buscar_elemento(Lista **l, int id) {  
    ...
    if ( p->aluno.id == id ) {
        ...
        printf("Identificador n�o encontrado\n");
        return NULL;
...
// fun��o que verifica se ela esta vazia 
...
void imprime_amigos ( Lista **a, Lista **l ) {  
    ...
    if(  (*a)->aluno.amigos != NULL ) {
        ...
        printf ("N�o possui amigos!");

    }

}

// insere uma rela��o de amizade
...
while ( w == 0 ) {
    ...
    switch (opcao){
        ...
        case 1:;    // ADICIONANDO ALUNO � LISTA
        ...
        case 5:;    //INSERINDO RELA��O DE AMIZADE
        ...
        case 6:;    //REMOVENDO RELA��O DE AMIZADE

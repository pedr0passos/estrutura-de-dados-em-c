...
while ( fscanf(arq, "%[^\t]%d%[^\n]", a->nome, &a->id, a->curso) != EOF ) {
    ...
    // passando o conte�do do que foi lido pelo while para o aluno que ser inserido na lista dup encadeada
    n->aluno = *a;
...
while ( w == 0 ) {
    ...
    printf("5 - Inserir rela��o de amizade\n");
    printf("6 - Remover rela��o de amizade\n");
    ...
    switch (opcao){
        ...
        case 1:;    //INSERE UM ALUNO NA LISTA
            ...
            //ORDENA��O DA LISTA ( ORDEM ALFAB�TICA)

            if ( !lista_vazia(&lista)) {   
                
                if ( lista->proximo == NULL && lista->anterior == NULL ) {      //INSERE QUANDO H� APENAS 1 ELEMENTO NA LISTA                           
        ...
        case 3:;   //   REMOVE UM ALUNO
            ...
            } else {    // CASE O ALUNO N�O SEJA ENCONTRADO 
        ...
        case 5:;    // INSERE RELA��O DE AMIZADE
            
            int id_amigo_1, id_amigo_2;
            
            linha();
            printf("INSERINDO RELA��O DE AMIZADE:");
            linha();
        ...
        case 6:;    // REMOVE RELA��O DE AMIZADE
            
            linha();
            printf("REMOVENDO RELA��O DE AMIZADE:");
            linha();
        ...
        case 8:;    // IMPRIME OS ALUNOS DE UM CURSO ESPECIFICO 
            ...
            if ( !lista_vazia(&lista) ) {
                ...
                if ( contador == 0 ) {
                    ...
                    linha();
                    printf("N�o existe alunos desse curso na lista.");
                    linha();
        ...
        default:;   // DEFAULT  
            ...
            linha();
            printf("Op��o Inv�lida! Execute novamente.");
            linha();
